...
# cap = cv2.VideoCapture(0)  # Open webcam (change to 1 if using an external camera)
...
# # Ensure the camera is released and resources are cleaned up when the app stops
